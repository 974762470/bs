               ...
               <div class="x_content">
				<table class="table table-bordered table table-hover table table-striped">
					<thead>
						<tr>
							<th width="12%">课题名</th>
							<th align="center">课题难度</th>
							<th align="center">课题工作量</th>
							<th align="center">课题来源</th>
							<th align="center">课题类型</th>
							<th width="25%" align="center">课题描述</th>
					...
					<tbody>
						<c:forEach items="${thesisTitleList }" var="thesis" varStatus="loop">
							<tr>
								...
								<td align="center">${thesis.nandu }</td>
								<td align="center">${thesis.liang }</td>
								<td align="center">${thesis.from }</td>
								<td align="center">${thesis.leixing }</td>
								<td align="center">${thesis.description }</td>
								<td align="center">${thesis.inputMan }</td>
								<td align="center">${thesis.statusStr }</td>
								<td>
								...
								<a class="btn btn-info btn-xs" href="<c:url value="/student/selectThesis?studentId=${sessionScope.student.id }&thesisId=${thesis.id }"/>"><i class="fa fa-check"></i>选择</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
