			...
			<div class="col-md-8">
				...
				<form role="form" class="form-horizontal" action="${pageContext.request.contextPath}/student/modifyInfoToDb" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="studentName" name="studentName" value="${sessionScope.student.studentName }" readonly>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<button type="button" class="btn btn-default" id="sex" disabled="disabled">${sessionScope.student.sex }</button>
					...
					<%-- 	<div class="col-sm-10">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="grade" name="grade" value="${sessionScope.student.grade }" readonly>
						</div>
						<%-- <div class="col-sm-10">
